...
public class mes_xiaoyuzhong  extends Activity implements OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mes_xiaoyuzhong);

        lvNews = (ListView) findViewById(R.id.mest);
